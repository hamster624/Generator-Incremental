    ...
    const calculatorHTML = `
        <div id="calculator" style="display: none; position: fixed; inset-block-start: 20%; inset-inline-start: 20%; inline-size: 400px; background: black; color: white; border: 1px solid white; padding: 20px; z-index: 1000;">
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: center; margin-block-end: 10px;">
                ...
                <button onclick="performOperation('1000arrow')" style="inline-size: 30%; background: black; color: white; border: 1px solid white;">1000 Arrow</button>
                <button onclick="performOperation('10000arrow')" style="inline-size: 30%; background: black; color: white; border: 1px solid white;">10000 Arrow</button>
                <button onclick="performOperation('100000arrow')" style="inline-size: 30%; background: black; color: white; border: 1px solid white;">100000 Arrow</button>
                <button onclick="performOperation('1000000arrow')" style="inline-size: 30%; background: black; color: white; border: 1px solid white;">1000000 Arrow</button>
